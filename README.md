...
بالبداية هذا عبارة عن طريقة حل تحدي  Hunter  وهذا رابط التحدي https://cyberdefenders.org/labs/32 كتحضير أو أخذ نبذة عن طريقة إختبار DFP من elearnsecurity
التحدي عبارة عن 30 سؤال للإجابة عليها يتطلب تحليل كامل ل Windows Image 
